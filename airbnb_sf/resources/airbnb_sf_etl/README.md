...
This folder defines all source code for the airbnb_sf pipeline:
...
* Take a look at the sample under "sample_trips_airbnb_sf.py" to get familiar with the syntax.
