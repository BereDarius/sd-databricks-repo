...
The 'airbnb_sf' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/airbnb_sf_etl`: Pipeline code and assets for the airbnb_sf_etl pipeline.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] airbnb_sf_etl` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/airbnb_sf_etl/airbnb_sf_job.job.yml). The schedule
