...
The 'wanikani' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/wanikani_etl`: Pipeline code and assets for the wanikani_etl pipeline.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] wanikani_etl` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/wanikani_etl/wanikani_job.job.yml). The schedule
